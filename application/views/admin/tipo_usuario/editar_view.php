            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-default toggle panelMove panelClose panelRefresh">
                    ...
                    <div class="panel-body pt0 pb0">
                        <form class="form-horizontal group-border stripped" id="form-criar_tipo_usuario" action="tipo_usuario/atualizar" method="post" role="form" >
                            <input type="hidden" value="<?=isset($tipo_usuario) ? $tipo_usuario->id_tipo_usuario : '';?>" name="id_tipo_usuario">
                            <div class="form-group">
                                ...
                                <div class="col-lg-10 col-md-9">
                                    <input type="text" class="form-control" autofocus="autofocus"
                                           value="<?= isset($tipo_usuario) ? $tipo_usuario->tipo : ''; ?>" id="tipo"
                                           name="tipo">
                                </div>
                            </div><!-- End .form-group  -->
                            <div class="form-group">
                                ...
                                <div class="col-lg-offset-2">
                                    ...
                                    <button type="button" onClick=top.window.location="tipo_usuario/cancelar"
