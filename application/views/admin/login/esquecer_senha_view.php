    ...
    <div class="row">
        <div class="navbar">
            <div class="container text-center">
                <a href="login"><img src="assets/img/logo_p.png" width="174" height="64"></a>
            </div>
        </div>
        <!-- /navbar -->
    </div>
...
<div class="container login-container">
    <div class="login-panel panel panel-default plain animated bounceIn">
        ...
        <div class="panel-body">
            <form class="form-horizontal mt0"  method="post" action="login/enviar_senha" id="esquecer-senha-form" role="form">
                <div class="form-group">
                    ...
                    <div class="col-lg-12">
                        <div class="input-group input-icon">
                            <input type="text" name="username" id="username" class="form-control" placeholder="Escreva seu email de login ...">
                ...
                <div class="form-group mb0">
                    <div class="col-md-12">
                        <? $this->load->view('layout/messages'); ?></br>
        ...
        <div class="panel-footer gray-lighter-bg">
            ...
            <p class="text-center">Você receberá sua senha por email.</p>
        </div>
    </div>
    <!-- End .panel -->
</div>
