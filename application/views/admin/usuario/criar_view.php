            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-default toggle panelMove panelClose panelRefresh">
                    ...
                    <div class="panel-body pt0 pb0">
                        <form class="form-horizontal group-border stripped" id="form-usuario" action="admin/usuario/salvar" method="post" role="form" >
                            <div class="form-group">
                                ...
                                <div class="col-lg-10 col-md-9">
                                    <input type="text" class="form-control" autofocus="autofocus"
                                           value="<?=isset($usuario) ? $usuario->nome : '';?>" id="nome" name="nome">
                                </div>
                            </div><!-- End .form-group  -->
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-3">
                                    <select name="id_tipo_usuario" id="select1" class="nostyle form-control" placeholder="Selecione um Tipo de Usuário">
                                        <option></option>
                                        <?
                                        $id = 	isset($usuario) ? $usuario->id_tipo_usuario : '';

                                          foreach ($tipo_usuario as $tipo) { ?>
                                            <option <?=($tipo->id_tipo_usuario == $id)?'selected':''?> value=<?= $tipo->id_tipo_usuario ?>><?= $tipo->tipo ?></option>
                                        <?	} ?>
                                    </select>
                                </div>
                            </div>
